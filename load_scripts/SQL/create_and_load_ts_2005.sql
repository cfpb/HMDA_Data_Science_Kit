DROP TABLE IF EXISTS hmda_public.ts_2005;
CREATE TABLE hmda_public.ts_2005 (
...
FROM '/Users/roellr/Documents/HMDA_Repos/HMDA_Data_Science_Kit/data/ts/ts_2005.dat' 
    ENCODING 'latin1';
COMMIT;

INSERT INTO hmda_public.ts_2005 (
	activity_year,
	agency_code,
	respondent_id,
	respondent_name,
