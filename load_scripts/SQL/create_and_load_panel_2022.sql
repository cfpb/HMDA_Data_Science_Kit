DROP TABLE IF EXISTS hmda_public.panel_2022;
CREATE TABLE hmda_public.panel_2022 (
...
COPY hmda_public.panel_2022
FROM '/Users/nongarda/Documents/HMDA_Data_Science_Kit/data/panel/panel_2022.txt' 
