DROP TABLE IF EXISTS hmda_public.panel_2006;
CREATE TABLE hmda_public.panel_2006 (
...
FROM '/Users/roellr/Documents/HMDA_Repos/HMDA_Data_Science_Kit/data/panel/panel_2006.dat' 
    ENCODING 'latin1';
COMMIT;
