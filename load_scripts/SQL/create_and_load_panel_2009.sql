DROP TABLE IF EXISTS hmda_public.panel_2009;
CREATE TABLE hmda_public.panel_2009 (
...
FROM '/Users/roellr/Documents/HMDA_Repos/HMDA_Data_Science_Kit/data/panel/panel_2009.dat' 
    ENCODING 'latin1';
COMMIT;
