...
DROP TABLE IF EXISTS hmda_lar_2009;
CREATE TABLE hmda_lar_2009
(  year varchar,
    rid varchar,
    agency varchar,
    loan_type varchar,
...
COPY lar_load
    ...
    FROM '/Users/roellk/HMDA/HMDA_Data_Science_Kit/data/lar/lar_ult_2009.dat';

COMMIT;

INSERT INTO hmda_lar_2009 (
    year,
    rid,
    agency,
    loan_type,
